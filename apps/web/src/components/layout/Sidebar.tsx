      ...
      >
        ...
        <nav className="p-3 space-y-1">
          ...
          <div className="mt-3 pt-3 border-t">
              <NavLink to="/app/inventory/items" icon={<span aria-hidden>📦</span>} label="Items" />
<NavLink
          ...
          <div className="mt-3 pt-3 border-t">
            <NavLink
              to="/app/orders/general"
              icon={<span aria-hidden>🧺</span>}
              label="General Cart"
            />
            <NavLink
              to="/app/orders/review"
              icon={<span aria-hidden>✅</span>}
              label="Ready to Place"
            />
            <NavLink
              to="/app/orders/placed"
              icon={<span aria-hidden>📦</span>}
              label="Placed Orders"
            />
            <NavLink
              to="/app/orders/archive"
              icon={<span aria-hidden>🗂️</span>}
              label="Archive"
            />
          </div>
